...
<?php /*<div class="makenew"<?php echo $par->hidden?>><span><?php echo JText::_('ADD_NEW_ANSWER');?></span></div>*/?>
<div class="newanswerbox answerbox">
	...
	<form action="index.php?option=com_jvotesystem&view=ajax&task=addAnswer&box=<?php echo $par->bid;?>" method="post">
		...
		<div>
			...
			<input type="button" value="<?php echo JText::_('RESET');?>" class="button" name="reset">
		</div>
	</form>
</div>
...
<div class="newanswerbox answerbox">
	...
	<form>
		<div class="text jvsclearfix">
			<textarea class="needLogin" type="text" rows="1" cols="90" name="answer" scrollbar=no data-start="<?php echo JText::_('ADD_NEW_ANSWER');?>"><?php echo JText::_('ADD_NEW_ANSWER');?></textarea>
		</div>
	</form>
</div>
<?php } ?>