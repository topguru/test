...
<div id="cj-wrapper">
				...
				<div class="survey-pages clearfix">
					<div class="pull-right">
						<ul class="unstyled inline">
							<li>
								<form action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.edit_questions&id='.$this->item->id)?>" method="get">
									<a class="btn btn-small btn-danger pull-right margin-left-10" href="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.finalize_survey&id='.$this->item->id.$itemid)?>">
									...
									<div class="page-actions pull-right margin-left-10">
										<div class="dropdown">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
												...
												<li>
													<a href="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.new_page&id='.$this->item->id.':'.$this->item->alias.$itemid)?>">
														<i class="fa fa-plus-circle"></i> <?php echo JText::_('LBL_NEW');?>
													</a>
												</li>
												<li>
													<a href="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.remove_page&id='.$this->item->id.':'.$this->item->alias.'&pid='.$this->pid.$itemid)?>">
					...
					<div class="accordion-group question-item">
						...
						<div id="qn-<?php echo $question->id?>" class="accordion-body collapse">
							<div class="accordion-inner">
								<form class="question-form" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.save_question&id='.$this->item->id.$itemid);?>" method="post">
					...
					<div class="modal-body">
						<ul id="page-ordering-list" class="nav nav-pills nav-stacked">
							...
							<li id="pageid-<?php echo $page->id;?>" class="">
								<a href="#"><i class="fa fa-arrows"></i> <?php echo JText::sprintf('LBL_PAGE', ($num + 1)).(!empty($page->title) ? ': '.$this->escape($page->title) : '');?></a>
							</li>
							<?php endforeach;?>
						</ul>
					</div>
	...
	<form id="file-upload-form" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.upload_answer_image'.$itemid);?>" 
	...
	<div style="display: none;">
		...
		<span id="url_delete_qn"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.delete_question&id='.$this->item->id.$itemid);?></span>
		<span id="url_update_ordering"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.update_ordering&id='.$this->item->id.$itemid);?></span>
		<span id="url_move_page"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.move_question&id='.$this->item->id.$itemid);?></span>
		<span id="url_save_rule"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.save_conditional_rule&id='.$this->item->id.$itemid);?></span>
		<span id="url_remove_rule"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.remove_conditional_rule&id='.$this->item->id.$itemid);?></span>
		<span id="url_rename_page"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.rename_page&id='.$this->item->id.$itemid);?></span>
		<span id="url_reorder_pages"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=formzs&task=formzs.reorder_pages&id='.$this->item->id.$itemid);?></span>
