						...
						<td width="51%" valign="top">
							<div id="cj-wrapper" style="border-width: 1px; border-style: solid; border-color: transparent #ccc transparent transparent;">
								<div class="container-fluid no-space-left no-space-right quizzes-wrapper">			
									<form name="quiz-form" class="quiz-form" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=quiz&task=form.save_quiz'.$itemid)?>" method="post">
										<fieldset>						
												...
												<div class="span12">
													<div class="clearfix">
														...
														<select name="catid" size="1">
															...
															<?php foreach($this->categories__ as $id=>$title):?>
															<option value="<?php echo $id;?>"<?php echo ($this->item->catid == $id) ? ' selected="selected"' : ''?>>
													...
													<div class="clearfix">
														...
														<input name="title" type="text" class="input-large required" value="<?php echo $this->escape($this->item->title);?>" placeholder="<?php echo JText::_('TXT_TITLE_HELP');?>">
													</div>
								
													<div class="clearfix">
														<label><?php echo JText::_('LBL_ALIAS');?>:</label>
														<input name="alias" type="text" class="input-large" value="<?php echo $this->escape($this->item->alias);?>" placeholder="<?php echo JText::_('TXT_ALIAS_HELP');?>">
													</div>
													
													<div class="clearfix">
														<label><?php echo JText::_('LBL_DESCRIPTION');?>:</label>
														<?php echo CJFunctions::load_editor($editor, 'description', 'description', $this->item->description, '5', '40', '99%', '200px', '', 'width: 80%;'); ?>
														<span class="help-block"><?php echo JText::_('TXT_DESCRIPTION_HELP');?></span>
													</div>
												</div>
											</div>
											
											<legend><?php echo JText::_('LBL_QUIZ_OPTIONS');?></legend>
													...
													<div class="span6">
														...
														<div class="clearfix">
															...
															<select name="show-result" size="1">
																<option value="1" <?php echo $this->item->show_answers == '1' ? 'selected="selected"':'';?>><?php echo JText::_('LBL_SHOW');?></option>
														...
														<div class="clearfix">
															...
															<select name="show-template" size="1">
																<option value="1" <?php echo $this->item->show_template == '1' ? 'selected="selected"':'';?>><?php echo JText::_('LBL_SHOW');?></option>
														...
														<div class="clearfix">
															<label>
																<?php echo JText::_('COM_COMMUNITYQUIZ_LABEL_CUTOFF');?><sup>*</sup>:
											...
											<legend><?php echo JText::_('LBL_TAGS');?></legend>
											<div class="row-fluid">
												<div class="span6">
													<span class="help-block"><?php echo JText::_('TXT_FLDHLP_TAGS');?></span>
													<input type="text" size="40" id="input-tags" name="input-tags" data-provide="typeahead" class="input-xlarge" autocomplete="off" placeholder="<?php echo JText::_('TXT_TAGS_HELP');?>">
													<div class="quiz-tags">
									...
									<div style="display: none;">
										<span id="url-get-tags"><?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=quiz&task=get_tags'.$itemid)?></span>
												...
												<tr>
													<td width="50%" align="left">&nbsp;&nbsp;
														<select name="quizPages"
															id="quizPages" style="width: 100px;" onchange="pageChange();">
													...
													<tbody>
														...
														<tr>
															...
															<div style="width: 200px; float: left;"><b><span><?php echo JText::_('Quiz	 :	');?><span>
																		<a href="#" onclick="open_question(this); return false;">Question <?php echo $questionId->question_id; ?></a></span></span></div>
																...
																<tbody>
																	<tr>
																		...
																		<td><input type="hidden" name="categoryQuizComplete[]"
																			...
																			value="<?php echo $questionId->complete_giftcode; ?>" /> 
																			<a
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="well center">
							<a class="btn" href="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=quiz'.$itemid.'&task=quiz.get_latest_quizzes')?>"><?php echo JText::_('LBL_CANCEL');?></a>
	...
	<table class="table table-striped" id="quizCategoryTable"
		...
		<?php foreach ($this->categories as $i=>$category) { ?>
			<tr class="row<?php echo $i%2;?>">
				...
				<input type="hidden" value="<?php echo ($category->user_quiz_price*100); ?>">
				</td>
				<td align="right">
				<input type="text" value="<?php echo ($category->user_quiz_price*100); ?>" name="giftCodePrice" readonly="readonly">								
				</td>
			</tr>
			<?php } ?>
		</tbody>
