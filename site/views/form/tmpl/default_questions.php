									...
									<div class="navbar navbar-static-top">
										<div class="navbar-inner">
						                	...
						                	<ul class="nav">
												...
												if (!empty($_GET['task'])){ ?>
                                                <a href="index.php?option=com_awardpackage&view=quiz&task=quiz.get_latest_quizzes" id="qntype-image"><i class="fa fa-picture-o"></i> Back</a>												
												<?php }else
												{ ?>
                                                    <a href="<?php echo 'index.php?option=com_awardpackage&view=form&task=form.have_session&package_id='.JRequest::getVar('package_id').'&uniq_id='.JRequest::getVar('uniq_id');?>" id="qntype-image"><i class="fa fa-picture-o"></i> Back</a>
                                                   <?php } ?>
								...
								<div class="panel panel-default question-item">
									...
									<div id="qn-<?php echo $question->id?>" class="panel-body hide">
										<form class="question-form" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=form&task=form.save_question&id='.$this->item->id);?>" method="post">
											...
											<input type="hidden" name="quiz_id" value="<?php echo JRequest::getVar('quiz_id');?>" >
											<input type="hidden" name="qid" value="<?php echo JRequest::getVar('questionSelectedId'); ?>" />
					...
					<div id="tpl-question">
						<div class="panel panel-default question-item">
							...
							<div id="qn-qid0" class="panel-body hide">
								<form class="question-form" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=form&task=form.save_question&id='.$this->item->id);?>" method="post">
									<input type="hidden" name="uniq_id" value="<?php echo JRequest::getVar('uniq_id'); ?>" />
									<input type="hidden" name="id" value="<?php echo JRequest::getVar('quiz_id');?>" >
