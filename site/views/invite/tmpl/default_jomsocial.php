...
<div class="invite-jsgroups-wrapper">
	...
	<div style="display: none;">
		<span id="url_invite_js_groups"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=invite&task=invite.invite_jomsocial_groups&id='.$this->item->id.$itemid)?></span>
	</div>
</div>