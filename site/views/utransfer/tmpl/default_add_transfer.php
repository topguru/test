...
function onCancel(){
	window.location = "index.php?option=com_awardpackage&view=ufunding&task=utransfer.getMainPage";
}
function onContinue(){
	jQuery('#task').val('utransfer.addTransferConfirm');
			...
			<table>
				<tr>
					...
					<td valign="top">
						...
						<div class="span12">
							<fieldset>
                            <p>Please enter the amount of shopping credits you wish to<br/>
							transfer to your personal shopping credit account
                            <p>
								<h4>Transfer to personal :</h4>					
								<table border="0">
									<tr>
										<td>
