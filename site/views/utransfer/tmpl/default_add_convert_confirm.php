...
function onCancel(){
	window.location = "index.php?option=com_awardpackage&view=ufunding&task=utransfer.addConvert";
}
function onContinue(){
	jQuery('#task').val('utransfer.addConvertComplete');
			...
			<table>
				<tr>
					...
					<td valign="top">
						...
						<div class="span12">
							<fieldset>
                            <p>Please click 'Next' to convert the following amount to cash
                            <p>
								<h4>Convert to cash :	<?php echo number_format($this->totalsc,2); ?></h4>				
								<table border="0">
									<tr>
										<td>
