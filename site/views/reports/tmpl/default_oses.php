...
$doc->addScriptDeclaration('google.load("visualization", "1", {packages:["corechart"]}); google.setOnLoadCallback(QuizFactory.init_report_oses);');
?>
	...
	<table width="100%">
		<tr>
			...
			<td valign="top">
				...
				<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=reports.get_os_report&id='.$this->item->id)?>" method="post">
					...
					<div class="row-fluid">
						...
						echo CJFunctions::get_pagination(
								'index.php?option='.Q_APP_NAME.'&view=quiz&task=os_report&id='.$this->item->id.':'.$this->item->alias.$itemid, 
				...
				<div style="display: none;">
					...
					<span id="url_remove_responses"><?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=reports.remove_responses&id='.$this->item->id)?></span>
				</div>
			</td>
		</tr>
	</table>
