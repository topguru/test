			...
			<td valign="top">
				...
				<div class="well">
					<a class="btn pull-right" 
						...
						href="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=reports.get_consolidated_report&id='.$this->item->id.'&tmpl=component&print=1'.$itemid);?>">
						<i class="icon-print"></i> <?php echo JText::_('JGLOBAL_PRINT');?>
					</a>
					<a class="btn" href="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=reports.get_quiz_reports&id='.$this->item->id);?>">
