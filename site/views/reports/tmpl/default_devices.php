	...
	<table width="100%">
		<tr>
			...
			<td valign="top">
				...
				<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=reports.get_device_report&id='.$this->item->id)?>" method="post">
