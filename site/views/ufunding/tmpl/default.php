...
echo '<div class="span12">';
								...
								<h2 class="page-header margin-bottom-10 no-space-top">
									<?php 									
									echo JText::_('Funding'); ?>
								</h2>
                                <?php if (!empty($this->paycheck)) { ?>
								<span style="color:#000;"><i>Your Funds for Quiz and Survey only : $<?php echo number_format($this->remain,2); ?></i><br/></span>		
                                <?php } else { ?>
							...
							<fieldset>
								...
								<table border="0">
									<tr>
										<td>
											<input type="radio" name="rChoice" value="add_funds">&nbsp;Add funds
										</td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									...
									<tr>
										<td>
											<input type="radio" name="rChoice" value="withdraw_funds">&nbsp;Withdraw funds
										</td>
									</tr>
								</table>
							</fieldset>	
