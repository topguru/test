										...
										<li class="dropdown">
                                         ...
                                         <li>
                                          <?php 
												...
												if (!empty($_GET['task'])){ ?>
                                                <a href="index.php?option=com_awardpackage&view=survey&task=survey.get_all_surveys" id="qntype-image"><i class="fa fa-picture-o"></i> Back</a>												
												<?php }else
												{ ?>
                                                   <a href="<?php echo 'index.php?option=com_awardpackage&view=formzs&task=formzs.have_session&package_id='.$post['package_id'].'&uniq_id='.$post['uniq_id'];?>" id="qntype-image"><i class="fa fa-picture-o"></i> Back</a>
                                                   <?php } ?>
                                                   </li>
									</ul>
								</div>
						...
						<ul class="unstyled inline">
							<li>
								...
								<form name="adminForm" id="adminForm" action=""<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=question&task=question.edit&id='.$this->item->id.':'.$this->item->alias)?>" method="get">
									...
									<input type="hidden" name="uniq_id" id="uniq_id" value="<?php echo $post['uniq_id'];?>"> 
                                    <input type="hidden" name="questionSelectedId" id="questionSelectedId" value="<?php echo $post['questionSelectedId']; ?>" />
					...
					<div class="accordion-group question-item">
						...
						<div id="qn-<?php echo $question->id?>" class="accordion-body collapse">
							<div class="accordion-inner">
								<form class="question-form" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=question&task=question.save_question&id='.$this->item->id.$itemid);?>" method="post">
									<input type="hidden" name="uniq_id" id="uniq_id" value="<?php echo $post['uniq_id'];?>"> 
                                    <input type="hidden" name="questionSelectedId" id="questionSelectedId" value="<?php echo $post['questionSelectedId']; ?>" />
									<?php if($question->question_type != 1):?>
