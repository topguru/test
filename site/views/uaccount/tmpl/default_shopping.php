 ...
 <div id="tabs-1">
  <table class="table table-striped" style="border: 1px solid #ccc;">
										...
										?>										
											...
											<td class="hidden-phone"><?php echo '<a href="index.php?option=com_awardpackage&view=shoppingcreditplan&task=shoppingcreditplan.shopping_credit_account_description&fid='.$row->funding_history_id.'">'. ($row->credit > 0 ? $row->description : ''); ?> </a></td> <!-- [[CUSTOM]] RI , added link to shopping credit -->
