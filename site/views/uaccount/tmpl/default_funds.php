...
function onFilter(){
	...
	jQuery('form#adminForm').attr('action', 'index.php?option=com_awardpackage&view=uaccount&task=uaccount.getFunds&from='+from+'&to='+to);
	jQuery('form#adminForm').submit();	
}

</script>	
<form name="adminForm" action="index.php?option=com_awardpackage&view=uaccount&task=uaccount.getFunds" id="adminForm" method="post">
					...
					<td valign="top">
						<div class="span12" style="margin:0;">
							<div class="well">
                               ...
                               <li  class="active"><a href="<?php echo JRoute::_("index.php?option=com_awardpackage&view=uaccount&task=uaccount.getFunds");?>">Funds</a>	</li>
  ...
  <table class="table table-striped" style="border: 1px solid #ccc;">
													<thead>
														<tr>
															...
															<th><u><?php echo JText::_('Total funds')?></u></th>
														</tr>
													</thead>
                                                   <tbody>
