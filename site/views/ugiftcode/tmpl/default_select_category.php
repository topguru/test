...
function discard_symbol(){	
	jQuery('#category').val(category);
	jQuery('#task').val('ugiftcode.discard_symbol');
	jQuery('form#adminForm').submit();}
...
<div id="cj-wrapper">	
						...
						<div class="span12">
							<div class="well">
                              ...
                              <li><a href="<?php echo JRoute::_("index.php?option=com_awardpackage&view=ugiftcode&task=ugiftcode.getHistoryGiftcode");?>">Giftcode History</a></li>	
                                ...
                                Unlocked Giftcode <?php echo ' ( Category '.$this->tot_symbol.' ) :	';	
								$total_giftcode = count($this->usercollection);
								$total = count($this->collects); 
								//echo $this->tot_symbol;
								echo $total_giftcode.' / '.$total;
								?>				
							</div>
						</div>		
						<div class="span12">
 ...
 echo '<div id="loadSymbol" class="modal hide fade" style="height:500px; width:900px;padding:5px;">';?>
