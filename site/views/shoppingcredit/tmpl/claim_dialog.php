...
<form action="<?php echo JRoute::_('index.php?option=com_awardpackage&controller=shoppingcredit&task=save_claim&tmpl=component');?>" method="post">
    <button name="save" style="float: right; padding: 5px;">Save & Close</button>
    <div style="clear:both;"></div>
    <h4>
        Would you like to claim your shopping credits now ?
    </h4> 
    ...
    <input type="hidden" name="record_id" value="<?php echo JRequest::getVar('record_id');?>">
</form>
</div>
