	...
	<table width="100%">
		<tr>
			...
			<td valign="top">
				...
				<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reportszs&task=reportszs.get_location_report&id='.$this->item->id)?>" method="post">
					...
					<div class="row-fluid">
						...
						echo CJFunctions::get_pagination(
								'index.php?option='.S_APP_NAME.'&view=reportszs&task=reportszs.get_location_report&id='.$this->item->id, 
				...
				<div style="display: none;">
					...
					<span id="url_remove_responses"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reportszs&task=reportszs.remove_responses&id='.$this->item->id)?></span>
				</div>
			</td>
		</tr>
	</table>
