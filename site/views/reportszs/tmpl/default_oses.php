	...
	<table width="100%">
		<tr>
			...
			<td valign="top">
				...
				<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reportszs&task=reportszs.get_os_report&id='.$this->item->id)?>" method="post">
					...
					<div class="row-fluid">
						...
						echo CJFunctions::get_pagination(
								'index.php?option='.S_APP_NAME.'&view=reportszs&task=reportszs.get_os_report&id='.$this->item->id, 
