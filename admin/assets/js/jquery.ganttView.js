...
(function (jQuery) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    var block = jQuery("<div>", {
                        ...
                        "title": series.row_name + ", " + size + " days",
                        "css": {
    ...
    var DateUtils = {
        ...
        daysBetween: function (s, e) {
			
            var start = DateUtils.getDate(s);
            var end = DateUtils.getDate(e);
            if (!start || !end) {
                return 0;
            }
        ...
        getBoundaryDatesFromData: function (data, minDays) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    var start = Date.parse(DateUtils.getDate(data[i].series[j].start));
                    var end = Date.parse(DateUtils.getDate(data[i].series[j].end))
                    if (i == 0 && j == 0) {
                        minStart = start;
                        maxEnd = end;
                    }
        ...
        getDate: function (date) {
            ...
            //return new Date(parseInt(n[0]),parseInt(n[1]),parseInt(n[2]));
