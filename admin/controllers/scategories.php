...
class AwardpackageControllerSCategories extends JControllerLegacy {
    ...
    function get_categories() {
        ...
        $view = $this->getView('scategories', 'html');
    ...
    function delete(){
        ...
        if(!$id){
         ...
         $this->setRedirect('index.php?option='.Q_APP_NAME.'&view=scategories&task=scategories.get_categories&package_id='.JRequest::getVar("package_id"), $msg);    
    }
    ...
    function cancel(){
        ...
        $this->setRedirect('index.php?option='.Q_APP_NAME.'&view=scategories&task=scategories.list&package_id='.JRequest::getVar("package_id"),  'Operation cancelled.');
    }
    ...
    function save(){    	
        ...
        $this->setRedirect('index.php?option='.Q_APP_NAME.'&view=scategories&task=scategories.list&package_id='.JRequest::getVar("package_id"), $msg);
    }
    ...
    function refresh(){    	
        ...
        $this->setRedirect('index.php?option='.Q_APP_NAME.'&view=scategories&task=scategories.list&package_id='.JRequest::getVar("package_id"), JText::_('MSG_CATEGORIES_REFRESHED'));
    }
}
?>
