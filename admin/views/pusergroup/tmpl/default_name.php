...
if($this->task=='edit'){
	$edituserdata= $this->ug->getedtgroup(JRequest::getVar('package_id'), JRequest::getVar('criteria_id'));
}
?>
	...
	<tbody>
		<tr>
			...
			<td align="center">
				...
				value="<?php echo ($this->task == 'edit' ? $edituserdata->firstname : ''); ?>" 
			...
			<td align="center">
				...
				value="<?php echo ($this->task == 'edit' ? $edituserdata->lastname : ''); ?>" 
