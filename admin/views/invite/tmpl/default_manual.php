...
<div class="invite-manual-wrapper">
	...
	<div class="well well-small">
		<?php echo str_replace('/administrator/', '/', JRoute::_('index.php?option='.S_APP_NAME.'&view=survey&task=take_survey&skey='.$this->item->survey_key.$surveys_itemid, false, -1));?>
	</div>
	...
	<table class="table table-striped table-hover table-condensed margin-top-20 table-urls-list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo str_replace('/administrator/', '/', JRoute::_('index.php?option='.S_APP_NAME.'&view=survey&task=take_survey&key='.$url->key_name.$surveys_itemid, false, -1))?>
				</td>
	...
	<div style="display: none;">
		<span id="url_get_urls_list"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=invite&task=invite.get_unique_urls_list&id='.$this->item->id);?></span>
		<span id="url_create_unique_urls"><?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=invite&task=invite.create_unique_urls&id='.$this->item->id);?></span>
	</div>
</div>