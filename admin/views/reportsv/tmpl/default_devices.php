...
<div id="cj-wrapper">
	...
	<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reportsv&task=reportsv.get_device_report&id='.$this->item->id.':'.$this->item->alias.$itemid)?>" method="post">
		...
		<div class="form-inline margin-bottom-20 well">
			...
			<h3 class="no-space-top no-space-bottom"><?php echo JText::_('LBL_DEVICES').': '.$this->escape($this->item->title);?></h3>
		</div>
		...
		<input type="hidden" name="task" value="reportsv.get_device_report">
	</form>
