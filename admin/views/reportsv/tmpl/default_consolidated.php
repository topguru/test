...
require_once JPATH_ROOT.DS.'components'.DS.S_APP_NAME.DS.'helpers'.DS.'reports.php';
...
<div id="cj-wrapper">
	<div class="container-fuild <?php echo $this->print ? ' full-screen' : '';?>">
		...
		<div class="well">
			<a class="btn pull-right" 
				...
				href="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reports&task=consolidated&id='.$this->item->id.':'.$this->item->alias.'&tmpl=component&print=1'.$itemid);?>">
		...
		<form id="adminForm" name="adminForm" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reportsv&task=reportsv.get_survey_reports&id='.$this->item->id);?>" method="post">
			<input type="hidden" name="task" value="reportsv">
