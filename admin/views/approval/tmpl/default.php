...
<script type="text/javascript">
	function onReset(){
		...
		window.location = 'index.php?option=com_awardpackage&view=approval&task=approval.get_quizzes_list&package_id='+package_id;
	}
</script>
<div id="cj-wrapper">
	<div class="container-fluid quiz-wrapper nospace-left no-space-left no-space-right">
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<form id="adminForm" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=approval&task=approval.get_quizzes_list');?>" method="post" name="adminForm">
						...
						<div class="input-append">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a class="btn-reset" href="#" onclick="onReset();"><?php echo JText::_('LBL_RESET');?></a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<table class="table table-hover table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=form&task=form.do_edit&package_id='.JRequest::getVar('package_id').'&id='.$row->id)?>"><?php echo $this->escape($row->title);?></a></td>
								...
								<td><a href="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=approval&task=approval.preview_quiz&package_id='.JRequest::getVar('package_id').'&id='.$row->id);?>"><?php echo JText::_('LBL_PREVIEW')?></a></td>
					...
					<input type="hidden" name="task" value="approval.get_quizzes_list" />
