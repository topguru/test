...
include_once (JPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_awardpackage'.DS.'shared'.DS.'button_admin.php');

?>
<div id="j-main-container" class="span10">
<form method="post"
	action="<?php echo JRoute::_('index.php?option=com_awardpackage&view=userquiz&package_id='.JRequest::getVar("package_id"));?>"
	...
	?>
		<tr class="row<?php echo $i%2;?>">
			...
			<td><?php echo $category->category_name; ?></td>
				...
				name="user_quiz_price[]" <?php echo $this->readonly;?> /></td>
