...
$items = $this->model->getSelectedWinners($this->winner_id);
?>
        	...
        	<?PHP 
				...
				?>
                	<tr class="row<?PHP echo $i;?>">
                        ...
                        <td align="center">
                        <a href="<?PHP echo JRoute::_('index.php?option=com_awardpackage&view=selectwinner&layout=symbol_detail&package_id='.$this->package_id.'&presentation_id='.$this->presentation_id.'&ap_winner_id='.$item->ap_user_winner_id.'&winner_id='.$this->winner_id.'&back=winners');?>"><?PHP echo count($this->model->getSymbolTotal($item->ap_user_winner_id));?></a>
                        </td>
                        <td align="center">
                        	<a href="<?PHP echo JRoute::_('index.php?option=com_awardpackage&view=selectwinner&layout=returnedsymbol&package_id='.$this->package_id.'&presentation_id='.$this->presentation_id.'&ap_winner_id='.$item->ap_user_winner_id.'&winner_id='.$this->winner_id.'&back=winners');?>">
                        	<?PHP 
