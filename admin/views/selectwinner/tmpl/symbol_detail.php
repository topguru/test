<?PHP 
	...
	$items = $this->model-> getSymbolTotal(JRequest::getVar('ap_winner_id'));
?>
<form action="<?PHP echo JRoute::_('index.php?option=com_awardpackage&view=selectwinner&package_id='.$this->package_id.'&presentation_id='.$this->presentation_id);?>"  method="post" name="adminForm" id="selectwinner" class="form-validate">
