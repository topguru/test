...
require_once JPATH_COMPONENT_SITE.DS.'helpers'.DS.'qnresults.php';
...
<div id="cj-wrapper">
	...
	<div class="well">
		<a class="btn pull-right" 
			...
			<i class="icon-print"></i> <?php echo JText::_('COM_COMMUNITYQUIZ_PRINT');?>
		</a>
		<a class="btn" href="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=responses&id='.$this->item->id.':'.$this->item->alias.$itemid);?>">
