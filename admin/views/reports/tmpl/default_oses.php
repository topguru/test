...
<div id="cj-wrapper">
	...
	<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.Q_APP_NAME.'&view=reports&task=os_report&id='.$this->item->id.':'.$this->item->alias.$itemid)?>" method="post">
