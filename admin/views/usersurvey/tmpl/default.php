...
<form method="post"
	action="<?php echo JRoute::_('index.php?option=com_awardpackage&view=usersurvey&package_id='.JRequest::getVar("package_id"));?>"
...
<table class="table table-striped">
	...
	?>
		<tr class="row<?php echo $i%2;?>">
			...
			<td><input type="text" onkeypress="return isNumberKey(event)"
				value="<?php echo ($category->user_survey_price*100); ?>" 
                           				name="user_survey_price[]" <?php echo $this->readonly;?> /></td>
	...
	<input type="hidden" id="controller" name="controller" value="usersurvey" />
