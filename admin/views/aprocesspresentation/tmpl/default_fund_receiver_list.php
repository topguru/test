...
<form id="adminForm"
    ...
    <?php echo $this->pagination->getLimitBox(); ?>
			...
			foreach ($this->result as $row):
		                                ...
		                                $shortfall =  $valueFunded - $prizevalue ; 
        ...
        <tr>
					...
					<td style="text-align:center;">
                    <a target="_blank" href="index.php?option=com_awardpackage&view=aprocesspresentation&task=aprocesspresentation.fundReceiverList&process_id=<?php echo JRequest::getVar('process_id'); ?>&package_id=<?php echo JRequest::getVar('package_id'); ?>"><?php echo JText::_($row->title); ?>
                    </a>
                    </td>	                   				
					<td class="hidden-phone"><?php echo JText::_($row->firstname.' '.$row->lastname); ?></td>
					<td class="hidden-phone"><?php echo ( $inserted == 100 ? 'Unlocked' : 'Locked');
					 ?></td>
                    ...
                    <td style="text-align:center;"><?php echo $i; ?></td>
                    <td style="text-align:center;">
                    <a target="_blank" href="index.php?option=com_awardpackage&view=apresentationlist&task=apresentationlist.prizeStatusHistory&prize=<?php echo $row->prize_name;?>&process_id=<?php echo JRequest::getVar('process_id'); ?>&package_id=<?php echo JRequest::getVar('package_id'); ?>"><?php echo 'view'; ?>
                    </a>
                    </td>	
					<td style="text-align:center;"><a target="_blank" href="index.php?option=com_awardpackage&view=apresentationlist&task=apresentationlist.symbolSetStatus&prize=<?php echo $row->prize_name;?>&process_id=<?php echo JRequest::getVar('process_id'); ?>&package_id=<?php echo JRequest::getVar('package_id'); ?>"><?php echo $UserSymbol.'/'.$row->pieces; ?>
                     </a>
                     </td>	
				</tr>
                </tbody>
