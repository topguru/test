...
<form id="adminForm"
	...
	<input type="hidden" name="task" id="task" value="aprocesspresentation.fundPrizePlan" />
    ...
    <?php echo $this->pagination->getLimitBox(); ?>
        ...
        <tr>
					...
					<td style="text-align:center;"><a target="_blank" href="index.php?option=com_awardpackage&view=aprocesspresentation&task=aprocesspresentation.fundReceiverList&process_id=<?php echo JRequest::getVar('process_id'); ?>&package_id=<?php echo JRequest::getVar('package_id'); ?>">
										<?php echo count($this->startfundprize);
										//echo JText::_(number_format($row->fund_prize_plan, 0, '.', '')); ?>
                                        </a></td>	                   				
