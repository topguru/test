					...
					<table class="table table-hover table-condensed table-striped adminlist">
					    <thead>
					        <tr>
					            ...
					            <th width="50px"><?php echo JText::_('Surveys');?></th>
					            <th width="25px"></th>
					            <th width="25px"></th>
					    ...
					    <tbody>
					    	...
					    	$fields[] = array('header'=>JText::_('LBL_CATEGORY'), 'name'=>'title', 'type'=>'category', 'align'=>'left', 
					    					'src'=>$base_uri.'&task=scategories.add&package_id='.JRequest::getVar('package_id'), 'id'=>true, 'value'=>null);
					    	$fields[] = array('header'=>JText::_('LBL_QUIZZES'), 'name'=>'surveys', 'type'=>'text', 'align'=>'center');
					    	$fields[] = array('header'=>'', 'name'=>null, 'type'=>'up', 'align'=>'center', 'src'=>$base_uri.'&task=scategories.move_up&package_id='.JRequest::getVar('package_id'), 'id'=>true, 
											'value'=>'<i class="icon icon-arrow-up"></i>', 'attribs'=>array('class'=>'btn btn-mini tooltip-hover', 'title'=>JText::_('TXT_MOVE_UP')));
					    	$fields[] = array('header'=>'', 'name'=>null, 'type'=>'down', 'align'=>'center', 'src'=>$base_uri.'&task=scategories.move_down&package_id='.JRequest::getVar('package_id'), 'id'=>true, 
											'value'=>'<i class="icon icon-arrow-down"></i>', 'attribs'=>array('class'=>'btn btn-mini tooltip-hover', 'title'=>JText::_('TXT_MOVE_DOWN')));
					    	$fields[] = array('header'=>JText::_('LBL_EDIT'), 'name'=>null, 'type'=>'link', 'align'=>'center', 'src'=>$base_uri.'&task=scategories.add&package_id='.JRequest::getVar('package_id'), 'id'=>true, 'value'=>null);
					    	$fields[] = array('header'=>JText::_('LBL_DELETE'), 'name'=>null, 'type'=>'link', 'align'=>'center', 'src'=>$base_uri.'&task=scategories.delete&package_id='.JRequest::getVar('package_id'), 'id'=>true, 'value'=>null);
					    	$fields[] = array('header'=>JText::_('ID'), 'name'=>'id', 'type'=>'text', 'align'=>'center');
					    	//$fields[] = array('header'=>'Package ID', 'name'=>'package_id', 'type'=>'text', 'align'=>'center');
...
echo '<tr>';
echo '<td>'.$i.'</td>';
echo '<td><a href="'.$base_uri.'&task=scategories.add&id='.$cat->id.'&package_id='.JRequest::getVar('package_id').'">'.$cat->title.'</a></td>';
echo '<td>'.$cat->surveys.'</td>';
echo '<td></td>';
echo '<td></td>';
echo '<td><a href="'.$base_uri.'&task=scategories.add&id='.$cat->id.'&package_id='.JRequest::getVar('package_id').'">Edit</a></td>';
echo '<td><a href="'.$base_uri.'&task=scategories.delete&id='.$cat->id.'&package_id='.JRequest::getVar('package_id').'">Delete</a></td>';
echo '<td>'.$cat->id.'</td>';
echo '</tr>';
}
?>
